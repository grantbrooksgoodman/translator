...
public final class LocalTranslationArchiver {
    // MARK: - Type Aliases
    ...
    public func getValue(input: TranslationInput, languagePair: LanguagePair) -> Translation? {
        archive.first(where: { $0.input == input && $0.languagePair.to == languagePair.to })
    }

    public func getValue(hash: String, languagePair: LanguagePair) -> Translation? {
